...
export function Navigation({ title = "BookNest" }: NavigationProps) {
  ...
  return (
    <nav className="sticky top-0 z-40 border-b border-primary/30 bg-primary text-primary-foreground backdrop-blur-2xl backdrop-saturate-150 supports-[backdrop-filter]:bg-primary/70 md:border-border/60 md:bg-background/80 md:text-foreground md:supports-[backdrop-filter]:bg-background/60">
